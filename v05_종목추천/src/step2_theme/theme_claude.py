...
{{
  ...
  "themes": [
    {{
      ...
      "sectors_kr": ["국장 수혜 섹터"],
      "sectors_us": ["미장 수혜 섹터"],
      "tickers_hint_kr": ["국장 관련 종목 정확히 3개 — 대형주1 + 중소형주2 — 종목명(티커) 형식"],
      "tickers_hint_us": ["미장 관련 종목 정확히 7개 — 대형주2 + 중소형주5 — 종목명(TICKER) 형식"],
      "risk": "이 테마의 리스크 요인"
    }}
  ],
  "avoid_sectors": [
...
규칙:
- themes는 5~7개 (강도 순 정렬)
- 반드시 다양한 섹터를 커버할 것:
  에너지/정유, 반도체/AI, 방위산업/항공우주/드론, 바이오/제약,
  금/원자재, 2차전지/전기차, 로봇/자동화, 핀테크/금융, 소비재,
  소프트웨어/클라우드, 조선/해운, 원전/에너지전환 등
- 근거 없는 테마는 제외하되, 약한 테마도 포함 (약 등급으로)
- 미장 tickers_hint_us는 정확히 7개: 대형주 2개 + 중소형주 5개, "종목명(TICKER)" 형식
- 국장 tickers_hint_kr는 정확히 3개: 대형주 1개 + 중소형주 2개, "종목명(005930)" 형식
- 종목 힌트는 테마 수혜도가 높은 순서로 선별. 중복 종목 불가
