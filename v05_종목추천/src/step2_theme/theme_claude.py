...
{{
  ...
  "themes": [
    {{
      ...
      "sectors_kr": ["국장 수혜 섹터"],
      "sectors_us": ["미장 수혜 섹터"],
      "tickers_hint_kr": ["국장 관련 예시 종목 2~3개 — 종목명(티커) 형식"],
      "tickers_hint_us": ["미장 관련 예시 종목 5~8개 — 종목명(TICKER) 형식"],
      "risk": "이 테마의 리스크 요인"
    }}
  ],
  "avoid_sectors": [
...
- 미장 tickers_hint_us는 반드시 영문 티커 포함: "엔비디아(NVDA)" 형식
- 국장 tickers_hint_kr는 반드시 종목코드 포함: "삼성전자(005930)" 형식
